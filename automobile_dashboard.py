...
# Callback pro aktualizaci výstupního kontejneru
@app.callback(
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, 
                x='Year',
                y='Automobile_Sales',
                title='Yearly Mean Automobile sales for the whole period'))
            
# Plot 2 Total Monthly Automobile sales using line chart.
        yam= data.groupby('Month')['Automobile_Sales'].mean().reset_index()
        Y_chart2 = dcc.Graph(figure=px.line(yam, 
                x='Month',
                y='Automobile_Sales',
                title='Monthly Mean Automobile sales for the whole period'))
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data, 
                names='Vehicle_Type',
                values='Advertising_Expenditure',
                title='Total Advertisement Expenditure for each vehicle {}'.format(selected_year)))
